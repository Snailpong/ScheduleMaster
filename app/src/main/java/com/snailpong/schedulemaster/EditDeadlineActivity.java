...
public class EditDeadlineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn = (LinearLayout) findViewById(R.id.deadline_ed_edit);
        cancelBtn = (LinearLayout) findViewById(R.id.deadline_ed_cancel);
        deleteBtn = (LinearLayout) findViewById(R.id.deadline_ed_delete);
