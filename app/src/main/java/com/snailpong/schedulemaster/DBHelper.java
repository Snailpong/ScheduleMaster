...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table if not exists alarmset(_id integer primary key autoincrement, state text, vib_state text, name text, whatid integer, year integer, month integer, day integer, hour integer, min integer)");
        db.execSQL("create table if not exists alarm(_id integer primary key autoincrement, category integer, title text, content text, time integer)");
    }
